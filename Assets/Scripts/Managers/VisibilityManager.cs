...
namespace Requiem.Managers {
    public class VisibilityManager {
        ...
        public byte[,] Compute(bool bol_isPlayer, byte byt_sight, byte byt_originX, byte byt_originY){}
        ...
        private bool BlocksLight(byte byt_x, byte byt_y, byte byt_octant, byte byt_originX, byte byt_originY){}

        private void SetVisible(byte byt_x, byte byt_y, byte byte_octant, byte byt_originX, byte byt_originY){}

        private byte GetDistance(byte byt_x, byte byt_y){}
    }
}